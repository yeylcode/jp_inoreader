...
if(window.devicePixelRatio >= 2) {
	document.getElementById("i_1").innerHTML = '<img src="/icons/icon1_r.png" width="19px">';
	document.getElementById("i_2").innerHTML = '<img src="/icons/icon3_r.png" width="19px">';
	document.getElementById("i_3").innerHTML = '<img src="/icons/icon2_r.png" width="19px">';
	document.getElementById("i_4").innerHTML = '<img src="/icons/icon4_r.png" width="19px">';
}else{
	document.getElementById("i_1").innerHTML = '<img src="/icons/icon1.png" width="19px">';
	document.getElementById("i_2").innerHTML = '<img src="/icons/icon3.png" width="19px">';
	document.getElementById("i_3").innerHTML = '<img src="/icons/icon2.png" width="19px">';
	document.getElementById("i_4").innerHTML = '<img src="/icons/icon4.png" width="19px">';
}
...
function save_options(){
    ...
    if(chrome.runtime && chrome.runtime.sendMessage){
        chrome.runtime.sendMessage({"option_update": true});
    }
